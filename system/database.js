module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'presented by Hr999x'
      if (!('sk_author' in setting)) setting.sk_author = 'owner : 62 896-7008-0712'
      ...
      if (!('owners' in setting)) setting.owners = ['6289670080712', '62896700807121']
